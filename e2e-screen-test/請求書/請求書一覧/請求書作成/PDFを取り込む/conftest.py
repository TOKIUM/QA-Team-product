"""
pytest-playwright 共通設定（PDF取り込み画面テスト用）+ test_results対応
...
_log_file_path = os.path.join(LOGS_DIR, f"test_pdf_organizer_{_timestamp}.log")
_log_fh = None
_test_results = []
_session_start = None
...
def pytest_sessionfinish(session, exitstatus):
    ...
    json_path = os.path.join(LOGS_DIR, f"test_pdf_organizer_{_timestamp}.json")
